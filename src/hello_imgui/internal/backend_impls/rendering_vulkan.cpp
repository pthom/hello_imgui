...
void SetupVulkanWindow(ImGui_ImplVulkanH_Window* wd, VkSurfaceKHR surface, int width, int height)
{
    ...
    ImGui_ImplVulkanH_CreateOrResizeWindow(gVkGlobals.Instance, gVkGlobals.PhysicalDevice, gVkGlobals.Device, wd, gVkGlobals.QueueFamily, gVkGlobals.Allocator, width, height, g_MinImageCount);
}
...
{
    auto& gVkGlobals = HelloImGui::GetVulkanGlobals();
    ImGui_ImplVulkanH_DestroyWindow(gVkGlobals.Instance, gVkGlobals.Device, &g_MainWindowData, gVkGlobals.Allocator);
}
