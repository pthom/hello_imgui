...
function(hello_imgui_prepare_app app_name)
    ...
    if(TARGET hello_imgui_imported)
        message(WARNING "using hello_imgui_imported")
        target_link_libraries(${app_name} PRIVATE hello_imgui_imported)
    elseif(TARGET hello_imgui)
        message(WARNING "using hello_imgui")
        target_link_libraries(${app_name} PRIVATE hello_imgui)
    else()
        message(FATAL_ERROR "hello_imgui_prepare_app: can't find hello_imgui cmake target")
    endif()
