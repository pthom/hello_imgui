...
struct FpsIdling
{
    ...
    //
    // If false, rendering runs as fast as possible, or is limited by `maxFps`.
    ...
    // `maxFps`: _float, default = 0.f_ (unlimited).
    //
    ...
    //
    // If maxFps > 0, the application ensures that each frame takes at least
    // (1 / maxFps) seconds to render.
    //
    // When both vsyncToMonitor and maxFps are enabled:
