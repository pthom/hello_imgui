...
function(him_add_stb_image)
    ...
    # Suppress GCC false positive -Wstringop-overflow in stb_image.h (known GCC 12+ issue)
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        target_compile_options(stb_hello_imgui PRIVATE -Wno-stringop-overflow)
    endif()
...
function(him_has_vulkan target)
    ...
    if (HELLOIMGUI_VULKAN_VALIDATION)
        target_compile_definitions(${HELLOIMGUI_TARGET} PRIVATE HELLOIMGUI_VULKAN_VALIDATION)
    endif()
    set(HELLOIMGUI_HAS_VULKAN ON CACHE BOOL "" FORCE)
